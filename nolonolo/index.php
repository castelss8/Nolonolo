          ...
          <div class="carousel-inner">
            ...
            <div class="carousel-item">
              <div class="container h-100">
                <div class="row h-100 justify-content-center align-items-center">
                  <div class="col-md-7">
                    <h2 class="secondoTitolo">Tutto è possibile</h2>
                    <blockquote>I videogiochi in realtà virtuale ridefiniscono l'avventura, ridefiniscono l'esperienza umana, ridefiniscono qualsiasi cosa.</blockquote>
        ...
        <div class="container mt-4">
          ...
          <div class="responsive">
            <div class="card me-lg-4">
              <a href="#"><img src="media/6.png" class="bd-placeholder-img card-img-top img-fluid" width="100%" height="225"><div class="testoCentrato">I più venduti</div></a>
            </div>
            <div class="card me-lg-4">
              <a href="#"><img src="media/7.png" class="bd-placeholder-img card-img-top img-fluid" width="100%" height="225"><div class="testoCentrato">I più popolari</div></a>
            </div>
            <div class="card">
          ...
          <div class="responsive">
            <div class="card me-lg-4">
              ...
              <div class="card-body">
                ...
                <p class="card-text termine">Terminerà tra <span id="primaOfferta"></span> </p>
              </div>
            </div>
            <div class="card me-lg-4">
              ...
              <div class="card-body">
                ...
                <p class="card-text prezzoScontato">31.25€ <span class="prezzoIntero">62.50€</span></p>
                <p class="card-text termine">Terminerà tra <span id="secondaOfferta"></span> </p>
              </div>
            </div>
            <div class="card me-lg-4">
              ...
              <div class="card-body">
                ...
                <p class="card-text prezzoScontato">31.25€ <span class="prezzoIntero">62.50€</span></p>
                <p class="card-text termine">Terminerà tra <span id="terzaOfferta"></span> </p>
              </div>
            </div>
            <div class="card me-lg-4">
              ...
              <div class="card-body">
                ...
                <p class="card-text prezzoScontato">31.25€ <span class="prezzoIntero">62.50€</span></p>
                <p class="card-text termine">Terminerà tra <span id="quartaOfferta"></span> </p>
              </div>
            </div>
            <div class="card me-lg-4">
              ...
              <div class="card-body">
                ...
                <p class="card-text prezzoScontato">31.25€ <span class="prezzoIntero">62.50€</span></p>
                <p class="card-text termine">Terminerà tra <span id="quintaOfferta"></span> </p>
              </div>
            </div>
          </div>
        </div>
