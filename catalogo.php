        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 pt-5">
            ...
            $today = date ("Y/m/d");
                ...
                if($run->rowCount()>0){
                  ...
                  echo '<h3 class="text-center text-secondary w-100">Il sito è in manutenzione, non ci sono videogiochi da visualizzare. Ci scusiamo per il disagio.</h3>';
                }
            ?>
          </div>
        </div>
